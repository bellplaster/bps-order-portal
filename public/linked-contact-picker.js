(() => {
  ...
  function installStyles() {
    ...
    style.textContent = `
      ...
      .sheet-details-grid #contactMobile,
      ...
      .linked-contact-control>#contactName:focus,
      .sheet-details-grid #contactMobile:focus,
      .sheet-details-grid #requiredDate:focus{
        position:relative;
        z-index:2;
        box-shadow:inset 0 0 0 1px var(--bell-green,#006557)!important;
      }
      .linked-contact-control:not(:focus-within){
        box-shadow:none!important;
      }
      .linked-contact-control>#contactName::placeholder,
      #contactMobile::placeholder,
      ...
      .linked-contact-button img{
        display:block;
        width:15px;
        height:15px;
      }
      .linked-contact-button:hover{background:#f5f8f7}
      .linked-contact-button:focus-visible,
      .linked-contact-control.is-open .linked-contact-button{
        box-shadow:inset 0 0 0 1px var(--bell-green,#006557);
      }
      .linked-contact-menu{
        position:absolute;
        z-index:100003;
        ...
        border-radius:4px;
        background:#fff;
        box-shadow:0 10px 24px rgba(23,33,31,.16);
        box-sizing:border-box;
      }
      .linked-contact-menu[hidden]{display:none!important}
      .linked-contact-menu::before{
        content:"";
        position:absolute;
        top:-6px;
        right:13px;
      ...
      .linked-contact-option:hover,
      .linked-contact-option:focus{
        outline:0;
        background:#eef6f3;
      }
      ...
      .sheet-details-grid #requiredDate{
        ...
        background-image:url('/calendar.svg?v=20260731-1')!important;
      ...
      @media(max-width:760px){
        ...
        .linked-contact-menu{right:0;width:min(240px,calc(100vw - 32px))}
      }
    `;
